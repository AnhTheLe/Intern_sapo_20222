...
import getDescription from "api/chatGPTApi";
...
function ModalCreateProduct(props) {
    ...
    const handleAutoRenderDescription = async () => {
        let desc = await getDescription(productOnChange.name);
        setProductOnChange({ ...productOnChange, description: desc.result });
    };
                    ...
                    <div className="col-12 col-lg-6 mb-3">
                        <div className="d-flex flex-column justify-content-center align-items-start bg-white border-1 shadow-sm rounded w-100 py-3">
                            <div className="d-flex flex-row">
                                ...
                                <div
                                    className="fs-6 ms-4 mb-2 border-2 shadow-sm"
                                    onClick={() => {
                                        handleAutoRenderDescription();
                                    }}
                                >
                                    Auto render description
                                </div>
                            </div>
